...
- Link previews: `tools/social_previews.py` crops 1200x630 copies of the page photos into `assets/img/social/` and keeps the og:/twitter: tags in step (the service-area pages get theirs from their own generator). Re-run it after changing a page photo.
